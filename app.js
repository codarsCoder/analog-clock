  ...
  if(!method){   
    if(getITem("myWeatherCity")){
      ...
      setITem("myWeatherCity",myCity);
        ...
        api = `https://api.openweathermap.org/data/2.5/weather?q=${myCity}&appid=96d849954e75818e434c2040c99576c4&units=metric&lang=tr` ;
    } else {
          !(lat && lon) ? (method = 0 ,  myWeather()) : "";  
         api =  `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&appid=96d849954e75818e434c2040c99576c4&units=metric&lang=tr` ;
